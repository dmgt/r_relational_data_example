...
Ideas about two ways to filter missing data: 
...
test1 <- complete_catch_data %>%
          filter(complete.cases(.)) %>% # line I changed
          group_by(stockid) %>%
...
#They appear to both produce dataframes of 2616 x 7, no sure if there are other differences yet
